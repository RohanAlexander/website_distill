...
If you would like to receive invitations to the series, then you can subscribe by just sending an email to listserv@listserv.utoronto.ca with the following content:  
  sub toronto-data-workshop-l YOUR_FIRST_NAME YOUR_LAST_NAME
...
* *Thursday, 16 July 2020, 4-5pm*  
	**Casey Breen** (University of California, Berkeley, Demography)  
	 Casey is a PhD student in the Demography Department at Berkeley. He previously worked at IPUMS which is a part of the Institute for Social Research and Data Innovation at the University of Minnesota. Casey will talk about [CenSoc](https://censoc.berkeley.edu/) which is a project to link mortality data from the Social Security Administration with 1940 census records in the US.
...
* *Thursday, 20 August 2020, 4-5pm*  
	**Aije Egwaikhide** (IBM)  
	Aije is a Lead Data Scientist at IBM Systems Enablement. Aije will talk about getting data ready for OCR training.
